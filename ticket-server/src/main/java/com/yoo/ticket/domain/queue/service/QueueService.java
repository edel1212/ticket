...
public interface QueueService {
     ...
     *   <li>중복 등록: {@code ALREADY_IN_QUEUE(409)} 예외</li>
     *   <li>신규 등록: UUID 토큰 생성 → ZADD(score=현재시각ms) → ZSET/토큰 모두 1시간 TTL 설정</li>
     ...
     * @throws com.yoo.ticket.global.exception.BusinessException 열차 미존재(TRAIN_NOT_FOUND) 또는 중복 등록(ALREADY_IN_QUEUE)
     */
